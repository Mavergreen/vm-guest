...
# MEASURED: packer validate accepted this template, net_device and all,
# for each NIC vmavs installs with, on 2026-09-25, with Packer 1.16.1,
# qemu plugin 1.1.6 and vagrant plugin 1.1.7; this project's CI
# re-validates it on every push, so a newer 1.x plugin may have validated
# it since. The values are the machine vmavs installs and boots.
